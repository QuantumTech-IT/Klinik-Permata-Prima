...
public class DlgRegistrasiSEPPertama extends javax.swing.JDialog {
    ...
    private Connection koneksibpjs = koneksiDBBpjs.condb();
    ...
    private String kdkel = "", kdkec = "", kdkab = "", kdprop = "", nosisrute = "", BASENOREG = "", URUTNOREG = "", link = "", klg = "SAUDARA", statuspasien = "", pengurutan = "", tahun = "", bulan = "", posisitahun = "", awalantahun = "", awalanbulan = "",
            ...
            tampilkantni = Sequel.cariIsi("select tampilkan_tni_polri from set_tni_polri"), ADDANTRIANAPIMOBILEJKN = "no";
    private int kuota = 0;
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2024" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2024" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2024" }));
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-08-2024" }));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            Valid.textKosong(NoTelp, "No Telpon Harus Awalnya 08,10-13 digit");
        } else {
...
//                }
                ...
                Kdpnj.setText("BPJ");
                nmpnj.setText("BPJS");
                Catatan.setText("Anjungan Mandiri RUMKITAL JALA AMMARI");
            ...
            try {
                ...
                if (!NoSKDP.getText().equals("")) {
                    try {
                        ...
                        koneksibpjs.prepareStatement(
                                "insert into log_add_antrian values('0','" + Valid.SetTgl(TanggalSEP.getSelectedItem() + "") + "','" + TNoRw.getText() + "','addantrian','admin','" + utc + "','" + TPasien.getText() + "','" + TNoRw.getText() + "',"
                                + "'" + NmPoli.getText() + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();

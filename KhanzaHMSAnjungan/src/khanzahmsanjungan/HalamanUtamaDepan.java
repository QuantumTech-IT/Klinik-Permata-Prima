...
public class HalamanUtamaDepan extends javax.swing.JFrame {
    ...
    public HalamanUtamaDepan() {
        ...
        setIconImage(new ImageIcon(super.getClass().getResource("/picture/jalaammari.png")).getImage());
    ...
    private void initComponents() {
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/logo_rthb.jpg"))); // NOI18N
        PanelWall.setBackgroundImageType(usu.widget.constan.BackgroundConstan.BACKGROUND_IMAGE_STRECT);
        PanelWall.setForeground(new java.awt.Color(238, 238, 255));
        PanelWall.setOpaqueGradient(true);
        PanelWall.setPreferredSize(new java.awt.Dimension(250, 150));
        ...
        btnAdmin7.setText("ANTRIAN LOKET");
    ...
    private void btnAdmin8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdmin8ActionPerformed
        DlgCekinBpjs pilih = new DlgCekinBpjs(null, true);
        pilih.setSize(this.getWidth(), this.getHeight());
        pilih.setLocationRelativeTo(this);
        pilih.setVisible(true);

 ...
 * @author Kode
 */
public class DlgCekinBpjs extends javax.swing.JDialog {
    ...
    private int lebar = 0, tinggi = 0, i = 0;
     ...
     * @param id
     */
    public DlgCekinBpjs(java.awt.Frame parent, boolean id) {
        super(parent, id);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 215, 255)), "::[ Scan Barcode Pada Aplikasi Mobile JKN!! ]::", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Poppins", 0, 24), new java.awt.Color(0, 131, 62))); // NOI18N
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/qr-code.png"))); // NOI18N
        ...
        jPanel1.add(PanelWall, new java.awt.GridBagConstraints());
    ...
    private void BtnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCloseActionPerformed
        try {
            i = JOptionPane.showConfirmDialog(null, "Mau Buat SEP  ????", "Konfirmasi", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCekinBpjs dialog = new DlgCekinBpjs(new javax.swing.JFrame(), true);

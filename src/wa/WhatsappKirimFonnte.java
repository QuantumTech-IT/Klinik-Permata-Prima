...
//    private WhatsappTemplate templateWA=new WhatsappTemplate(null,false);
             ...
             public void windowClosed(WindowEvent e) {
                 try {
                     ...
                     if (selectedRow != -1) {
                         ...
                         selectedText.append(model.getValueAt(selectedRow, i)).append(" ");
                            }
                         TPesan.setText(selectedText.toString().trim());
                         TPesan.requestFocus();
                     }
                 } catch (Exception ex) {
                     ex.printStackTrace();
    ...
    private void initComponents() {
        ...
        BtnTemplate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/2.png"))); // NOI18N
        ...
        BtnKeluar.setBounds(640, 10, 30, 30);

        BtnTemplate1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        ...
        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-05-2024" }));

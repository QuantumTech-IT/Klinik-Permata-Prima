 ...
 * @author perpustakaan
 */
public class DlgMarkingImageObgyn extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMarkingImageObgyn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(885,674); 
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Marking Lokalis Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DlgMarkingImageObgyn.class.getName()).log(Level.SEVERE, null, ex);
        }
        Rectangle capture = 
            new Rectangle(Toolkit.getDefaultToolkit().getScreenSize());
            BufferedImage Image = r.createScreenCapture(panelGlass9.bounds());
        try {
            ImageIO.write(Image, "png", new File("tmpImageFreehand/assMdsBedah"+TNoRawat.getText().replaceAll("/", "")+".png"));
        } catch (IOException ex) {
            Logger.getLogger(DlgMarkingImageObgyn.class.getName()).log(Level.SEVERE, null, ex);
        }
        uploadImage("assMdsBedah"+TNoRawat.getText().replaceAll("/", "")+".png","assesmentmedisbedah/imagemarking");
        
        if(Sequel.cariInteger("select count(no_rawat) as jumlah from asesmen_medis_bedah_image_marking where no_rawat='"+TNoRawat.getText()+"'")>0){
            if(Sequel.mengedittf("asesmen_medis_bedah_image_marking","no_rawat=?","tanggal=?,jam=?,url_image=?",4,new String[]{
         ...
         if(Sequel.menyimpantf("asesmen_medis_bedah_image_marking","?,?,?,?","No.Rawat",4,new String[]{
                    TNoRawat.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),"assesmentmedisbedah/imagemarking/assMdsBedah"+TNoRawat.getText().replaceAll("/", "")+".png"
                })==true){
            }
        }
        dispose();
...
//        System.out.println(index);
    ...
    private void BtnHapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapus1ActionPerformed
        imageAssesment("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/imagefreehand/masterimage/LokalisOrtho.png");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMarkingImageObgyn dialog = new DlgMarkingImageObgyn(new javax.swing.JFrame(), true);
...
//        Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=? ",TPasien,TNoRM.getText());
    ...
    public void setNoRw(String norw) {
        ...
        urlImage=Sequel.cariIsi("select url_image from asesmen_medis_bedah_image_marking where no_rawat='"+norw+"' ");

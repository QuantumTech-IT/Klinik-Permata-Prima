...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private TokoPenjualan tokoRef;   // pegangan ke form toko
    // --- konstanta judul tab (samakan dg judul di UI-mu) ---
...
//
//// === setter dipanggil dari tempat yang membuat kedua dialog ===
//public void setTokoPenjualanRef(TokoPenjualan ref){
//    this.tokoPenjualanRef = ref;
//}
    private javax.swing.table.DefaultTableModel tabModeBarang;
     private javax.swing.table.DefaultTableModel tabModeBarang1;
    private java.text.DecimalFormat df2 = new java.text.DecimalFormat("#,##0");
    ...
    private int TAB_IDX_NON_RACIKAN = -1;
private int TAB_IDX_RACIKAN     = -1;
...
//dlgResep.setTokoPenjualanRef(dlgToko);
    ...
    private void initComponents() {
        ...
        SignaRacikan = new javax.swing.JTextField();
        LblNRacikan = new javax.swing.JLabel();
        NamaRacikan = new javax.swing.JTextField();
        LblSRacik = new javax.swing.JLabel();
        BtnTambahRacikan = new javax.swing.JButton();
        jScrollPane3 = new javax.swing.JScrollPane();
        petunjuk = new javax.swing.JTextArea();
        ...
        tbTokoBarang = new javax.swing.JTable();
        jScrollPane2 = new javax.swing.JScrollPane();
        tbTokoBarang1 = new javax.swing.JTable();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(550, 180));
        ...
        SignaRacikan.setName("SignaRacikan"); // NOI18N
        FormInput.add(SignaRacikan);
        SignaRacikan.setBounds(360, 120, 200, 30);

        LblNRacikan.setText("Nama Racikan :");
        LblNRacikan.setName("LblNRacikan"); // NOI18N
        FormInput.add(LblNRacikan);
        LblNRacikan.setBounds(610, 130, 100, 14);

        NamaRacikan.setName("NamaRacikan"); // NOI18N
        FormInput.add(NamaRacikan);
        NamaRacikan.setBounds(700, 120, 200, 30);

        LblSRacik.setText("Signa Racikan :");
        LblSRacik.setName("LblSRacik"); // NOI18N
        FormInput.add(LblSRacik);
        LblSRacik.setBounds(270, 130, 100, 14);
        ...
        FormInput.add(BtnTambahRacikan);
        BtnTambahRacikan.setBounds(780, 90, 120, 23);
        ...
        jScrollPane3.setBounds(910, 10, 360, 140);
        ...
        tbTokoBarang.setName("tbTokoBarang"); // NOI18N
        jScrollPane1.setViewportView(tbTokoBarang);

        TabRawat.addTab("Resep Non Racikan", jScrollPane1);

        jScrollPane2.setName("jScrollPane2"); // NOI18N

        tbTokoBarang1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        TabRawat.addTab("Resep Racikan", jScrollPane2);
...
if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
    // jangan panggil BtnCariActionPerformed(null) lagi kalau di dalamnya sudah memanggil tampil…()
    System.out.println("[TCari Action] ENTER: '" + TCari.getText() + "'");
    refreshByActiveTab(TCari.getText().trim());
...
//            //tampiltokobarang();
//            tampilTokoBarang(TCari.getText());
//            tampilTokoBarang1(TCari.getText());
//        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
//            BtnCari.requestFocus();
//        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
//            BtnKeluar.requestFocus();
...
//        }
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
       simpanKeResepToko(); // TODO add your handling code here:
    }//GEN-LAST:event_BtnSimpan1ActionPerformed

    private void NoResepTokoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoResepTokoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoResepTokoKeyPressed
...
//            NoResepToko.setEditable(false);
//            NoResepToko.setBackground(new Color(245,250,240));
//            autoNoResepToko();
//        }else if(ChkRM1.isSelected()==false){
//            NoResepToko.setEditable(true);
//            NoResepToko.setBackground(new Color(250,255,245));
//            NoResepToko.setText("");
//        }        // TODO add your handling code here:
    ...
    */
    ...
    private javax.swing.JLabel LblNRacikan;
    private javax.swing.JLabel LblSRacik;
    private javax.swing.JTextField NamaRacikan;
    ...
    private javax.swing.JTextField SignaRacikan;
    ...
    private javax.swing.JTextArea petunjuk;
    ...
    private javax.swing.JTable tbTokoBarang;
    private javax.swing.JTable tbTokoBarang1;
                ...
                try{
                    ...
                    while(rsobat.next()){
                        tabModeResep.addRow(new Object[] {
                           ...
                           rsobat.getString("nama_industri"),rsobat.getDouble("h_beli"),rsobat.getDouble("stok")
                        });    
                    }  
                }catch(Exception e){
 ...
 private void initTableTokoBarang() {
    tabModeBarang = new javax.swing.table.DefaultTableModel(
        null,
        new Object[]{"Jumlah","Aturan Pakai","Kode","Nama","Kategori","Satuan","Stok","Kandungan"}
    ){
        Class<?>[] types = new Class[]{
        ...
        @Override public boolean isCellEditable(int r,int c){ 
            // hanya kolom Jumlah (0) dan Aturan Pakai (1) yang editable
            return c==0 || c==1;
        }
    };
    
    tbTokoBarang.setModel(tabModeBarang);
    tbTokoBarang.setAutoCreateRowSorter(true);
}
    private void styleTokoBarang() {
    // Header biru tebal, teks putih
    javax.swing.table.JTableHeader header = tbTokoBarang.getTableHeader();
    header.setReorderingAllowed(false);
    header.setForeground(java.awt.Color.WHITE);
    header.setBackground(new java.awt.Color(0, 170, 204));
    header.setFont(header.getFont().deriveFont(java.awt.Font.BOLD));
    // ubah tinggi baris
    tbTokoBarang.setRowHeight(32);  // default biasanya 16–18, jadi ini lebih tingg
    // ubah font isi tabel
    tbTokoBarang.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 14));
    // ubah font header tabel
    header.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));

    // Zebra striping renderer
    javax.swing.table.TableCellRenderer zebra = new javax.swing.table.DefaultTableCellRenderer() {
        final java.awt.Color ODD  = new java.awt.Color(250, 250, 250);
        final java.awt.Color EVEN = new java.awt.Color(238, 243, 250);

        @Override
        public java.awt.Component getTableCellRendererComponent(javax.swing.JTable tbl, Object value,
            ...
            if (c instanceof javax.swing.JLabel) {
                ((javax.swing.JLabel)c).setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 8, 0, 8));
            }
            return c;
        }
    };
    ...
    for (int i = 0; i < tbTokoBarang.getColumnModel().getColumnCount(); i++) {
        tbTokoBarang.getColumnModel().getColumn(i).setCellRenderer(zebra);
    }

    // Kolom Stok (index 4) rata kanan
    ...
    tbTokoBarang.getColumnModel().getColumn(4).setCellRenderer(right);

    // Kolom lebar (opsional, sesuaikan)
    int[] widths = {90, 220, 140, 90, 100, 120};
    for (int i = 0; i < widths.length; i++) {
        tbTokoBarang.getColumnModel().getColumn(i).setPreferredWidth(widths[i]);
    }
}
   private void setupTokoBarangTableUI() {
    // ukuran kolom (sesuaikan selera)
    int[] widths = {90, 220, 140, 90, 110, 120}; // Kode, Nama, Kategori, Satuan, Stok, Letak
    for (int i = 0; i < widths.length; i++) {
        tbTokoBarang.getColumnModel().getColumn(i).setPreferredWidth(widths[i]);
    }

    // tinggi baris & jarak antar sel
    tbTokoBarang.setRowHeight(26);
    tbTokoBarang.setIntercellSpacing(new java.awt.Dimension(0, 1));
    tbTokoBarang.setShowGrid(false); // modern look

    // header tebal
    javax.swing.table.JTableHeader header = tbTokoBarang.getTableHeader();
    java.awt.Font bold = header.getFont().deriveFont(java.awt.Font.BOLD, header.getFont().getSize() + 0f);
    header.setFont(bold);
    header.setReorderingAllowed(false);

    // align kanan kolom angka: Stok (index 4)
    javax.swing.table.DefaultTableCellRenderer right = new javax.swing.table.DefaultTableCellRenderer();
    right.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    tbTokoBarang.getColumnModel().getColumn(4).setCellRenderer(right);
   ...
   private void applyZebra(javax.swing.JTable table) {
    final java.awt.Color ODD  = new java.awt.Color(250, 250, 250); // baris ganjil
    final java.awt.Color EVEN = new java.awt.Color(238, 243, 250); // baris genap
    final java.awt.Color SEL  = new java.awt.Color(33, 150, 243);  // biru seleksi
    final java.awt.Color SEL_FG = java.awt.Color.WHITE;

    // renderer umum untuk semua kolom
    javax.swing.table.TableCellRenderer base = new javax.swing.table.DefaultTableCellRenderer() {
        @Override
        public java.awt.Component getTableCellRendererComponent(javax.swing.JTable tbl, Object value,
                                                                boolean isSelected, boolean hasFocus,
                                                                int row, int column) {
            ...
            // padding kiri/kanan sedikit biar lega
            if (c instanceof javax.swing.JLabel) {
                ((javax.swing.JLabel)c).setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 8, 0, 8));
            }
            return c;
    ...
    for (int i = 0; i < table.getColumnModel().getColumnCount(); i++) {
        // Khusus kolom Stok (index 4) tetap align kanan, jadi kombinasikan:
        if (i == 4) {
            javax.swing.table.DefaultTableCellRenderer right = new javax.swing.table.DefaultTableCellRenderer() {
                @Override
                public java.awt.Component getTableCellRendererComponent(javax.swing.JTable tbl, Object value,
   ...
   public void tampiltokobarang() {
    Valid.tabelKosong(tabModeBarang);
    ...
    "  tb.kode_brng, " +
    "  tb.nama_brng, " +
    "  tj.nm_jenis AS kategori, " +
    "  tb.kode_sat2 AS satuan, " +
    "  COALESCE(tb.stok,0)*COALESCE(tb.isi,1)*COALESCE(tb.kapasitas,1) AS stok_total, " +
    "  tb.kandungan AS kandungan " +
    "FROM tokobarang tb " +
    "INNER JOIN tokojenisbarang tj ON tj.kd_jenis = tb.jenis " +
    "WHERE tb.status='1' " +
    "  AND COALESCE(tb.stok,0)*COALESCE(tb.isi,1)*COALESCE(tb.kapasitas,1) > 0 " + // << hanya yang stok ada
    "  AND ( " +
    "       tb.kode_brng LIKE ? " +
    "    OR tb.nama_brng LIKE ? " +
    "    OR tj.nm_jenis LIKE ? " +
    "    OR tb.kode_sat2 LIKE ? " +
    "    OR tb.kandungan LIKE ? " +
    "  ) " +
    ...
    rs.getString("satuan"),
    rs.getDouble("stok_total"),
    rs.getString("kandungan")
});
            }
        }
    } catch (Exception e) {
        System.out.println("Notifikasi tampiltokobarang: " + e);
    }
}
   
   private void initTableTokoBarang1() { // khusus tab Resep Racikan
    tabModeBarang1 = new javax.swing.table.DefaultTableModel(
        null,
        new Object[]{"Jumlah","Kode","Nama","Kategori","Satuan","Stok","Kandungan","Nama Racikan"}
    ){
        Class<?>[] types = new Class[]{ Double.class,String.class,String.class,String.class,String.class,Double.class,String.class,String.class };
    @Override public Class<?> getColumnClass(int c){ return types[c]; }
    @Override public boolean isCellEditable(int r,int c){ return c==0; } 
    };
    tbTokoBarang1.setModel(tabModeBarang1);
    int COL_NAMA_R = 7;
tbTokoBarang1.getColumnModel().getColumn(COL_NAMA_R).setMinWidth(0);
tbTokoBarang1.getColumnModel().getColumn(COL_NAMA_R).setMaxWidth(0);
tbTokoBarang1.getColumnModel().getColumn(COL_NAMA_R).setPreferredWidth(0);
    tbTokoBarang1.setAutoCreateRowSorter(true);
    applyZebra(tbTokoBarang1);
}
   
   private void styleTokoBarang1() {
    javax.swing.table.JTableHeader header = tbTokoBarang1.getTableHeader();
    header.setReorderingAllowed(false);
    header.setForeground(java.awt.Color.WHITE);
    header.setBackground(new java.awt.Color(0, 170, 204));
    header.setFont(header.getFont().deriveFont(java.awt.Font.BOLD, 14f));

    tbTokoBarang1.setRowHeight(32);
    tbTokoBarang1.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 14));
    tbTokoBarang1.setAutoCreateRowSorter(true);

    // kolom angka (stok) rata kanan
    javax.swing.table.DefaultTableCellRenderer right = new javax.swing.table.DefaultTableCellRenderer();
    right.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    tbTokoBarang1.getColumnModel().getColumn(6).setCellRenderer(right);

    // zebra
    applyZebra(tbTokoBarang1);
}
   
   public void tampiltokobarang1() {
    Valid.tabelKosong(tabModeBarang1);
    String key = "%" + TCari.getText().trim() + "%";
    ...
    "  ) " +
    "ORDER BY tb.nama_brng";
try (PreparedStatement ps1 = koneksi.prepareStatement(sql)) {
        ps1.setString(1, key);
        ps1.setString(2, key);
        ps1.setString(3, key);
        ps1.setString(4, key);
        ...
        System.out.println("tampiltokobarang1: " + e.getMessage());
    }
}
 
   private void simpanKeResepToko() {
    // pastikan nilai sel ter-commit
    if (tbTokoBarang != null && tbTokoBarang.isEditing()) {
        try { tbTokoBarang.getCellEditor().stopCellEditing(); } catch (Exception ignored) {}
    }
    ...
    // deteksi ada item (ingat: racikan bisa sudah di-buffer stagedRacikan)
    boolean adaNR = adaItemQty(tbTokoBarang, 0);
    boolean adaR  = !stagedRacikan.isEmpty() || adaItemQty(tbTokoBarang1, 0);
    if (!adaNR && !adaR) {
        JOptionPane.showMessageDialog(null, "Tidak ada item resep (Non Racikan maupun Racikan).");
        return;
    }
    if (adaR && signaRacik.isEmpty() && stagedRacikan.stream().anyMatch(it -> it.signa==null || it.signa.trim().isEmpty())) {
        JOptionPane.showMessageDialog(null, "Signa Racikan belum diisi.");
        if (SignaRacikan != null) SignaRacikan.requestFocus();
        return;
    }

    // header sementara (akan diupdate lagi berdasarkan cntNR/cntR)
    String jenisHeader = (adaNR && adaR) ? "Campuran" : (adaR ? "Racikan" : "Non Racikan");

    final String sqlHeader =
        "INSERT INTO resep_toko (no_resep, no_rawat, kd_dokter, tgl_resep, keterangan) " +
        "VALUES (?,?,?,?,?) " +
        "ON DUPLICATE KEY UPDATE " +
        "  no_rawat=VALUES(no_rawat), kd_dokter=VALUES(kd_dokter), " +
        "  tgl_resep=VALUES(tgl_resep), keterangan=VALUES(keterangan)";
    ...
    try {
        ...
        try (PreparedStatement psH = koneksi.prepareStatement(sqlHeader)) {
            psH.setString(1, noResep);
            psH.setString(2, noRawat.isEmpty() ? null : noRawat);
            psH.setString(3, kdDokter.isEmpty() ? null : kdDokter);
            psH.setTimestamp(4, now);
            psH.setString(5, jenisHeader);
            psH.executeUpdate();
        }
        ...
        try (PreparedStatement psD = koneksi.prepareStatement(SQLD)) {
            ...
            // --- Non-Racikan (tbTokoBarang) ---
            for (int i = 0; i < tbTokoBarang.getRowCount(); i++) {
                double jml = Valid.SetAngka(String.valueOf(tbTokoBarang.getValueAt(i, 0)));
                if (jml <= 0) continue;

                String kode   = String.valueOf(tbTokoBarang.getValueAt(i, 2));
                if (kode == null || kode.trim().isEmpty()) continue;

                String satuan = String.valueOf(tbTokoBarang.getValueAt(i, 5));
                String aturan = String.valueOf(tbTokoBarang.getValueAt(i, 1));
                aturan = (aturan == null || aturan.trim().isEmpty()) ? null : aturan.trim();

                psD.setString(1, noResep);
                psD.setString(2, kode);
                psD.setDouble(3, jml);
                psD.setString(4, (satuan == null || satuan.isEmpty()) ? null : satuan);
                psD.setString(5, aturan);
                psD.setString(6, "Non Racikan");
            ...
            if (inserted == 0) {
                koneksi.rollback(); koneksi.setAutoCommit(true);
            ...
            try (PreparedStatement up = koneksi.prepareStatement(
                    "UPDATE resep_toko SET keterangan=? WHERE no_resep=?")) {
                up.setString(1, jenisFinal);
        ...
        koneksi.commit();
        JOptionPane.showMessageDialog(null, "Resep toko berhasil disimpan.");

        // bereskan buffer & reset qty
        stagedRacikan.clear();
        for (int i = 0; i < tbTokoBarang.getRowCount(); i++) {
            tbTokoBarang.setValueAt(0.0, i, 0);
            tbTokoBarang.setValueAt("",   i, 1);
        }
        for (int i = 0; i < tbTokoBarang1.getRowCount(); i++) {
            tbTokoBarang1.setValueAt(0.0, i, 0);
        }
        if (SignaRacikan != null) SignaRacikan.setText("");
        if (NamaRacikan != null)  NamaRacikan.setText("");
...
//    try { tbTokoBarang1.getCellEditor().stopCellEditing(); } catch (Exception ignored) {}
//}
//    System.out.println("Nama racikan: " + NamaRacikan.getText());
//    System.out.println("Signa racikan: " + SignaRacikan.getText());
//    String noResep  = NoResep.getText().trim();
//    String noRawat  = (TNoRw != null ? TNoRw.getText().trim() : "");
//    String kdDokter = (KdDokter != null ? KdDokter.getText().trim() : "");
//    java.sql.Timestamp now = new java.sql.Timestamp(System.currentTimeMillis());
...
//    }
//
//    // --- Ambil Signa Racikan (kalau ada isi racikan) ---
//    final String signaRacik = (SignaRacikan != null ? SignaRacikan.getText().trim() : "");
//
//    // --- Cek ada item di masing-masing tab (qty > 0) ---
//   commitTableEdits(tbTokoBarang, tbTokoBarang1);
//
//boolean adaNR = adaItemQty(tbTokoBarang, 0);
//boolean adaR  = !stagedRacikan.isEmpty() || adaItemQty(tbTokoBarang1, 0);
////    if (!adaNR && !adaR) {
...
////        return;
////    }
//    if (adaR && signaRacik.isEmpty()) {
//        JOptionPane.showMessageDialog(null, "Signa Racikan belum diisi.");
//        if (SignaRacikan != null) SignaRacikan.requestFocus();
//        return;
//    }
//
//    // --- Jenis header otomatis ---
//   String jenisHeader = (adaNR && adaR) ? "Campuran" : (adaR ? "Racikan" : "Non Racikan");
//
//    final String sqlHeader =
//        "INSERT INTO resep_toko (no_resep, no_rawat, kd_dokter, tgl_resep, keterangan) " +
...
//        
//
//  // --- Non-Racikan (langsung dari tbTokoBarang) ---
//  if (tbTokoBarang.isEditing()) try { tbTokoBarang.getCellEditor().stopCellEditing(); } catch(Exception ignore){}
//  for (int i=0;i<tbTokoBarang.getRowCount();i++){
//      double jml = Valid.SetAngka(String.valueOf(tbTokoBarang.getValueAt(i,0)));
//      if (jml<=0) continue;
//      String kode   = String.valueOf(tbTokoBarang.getValueAt(i,2));
...
//      psD.setString(5,aturan);
//      psD.setString(6,"Non Racikan");
//      psD.setNull(7,java.sql.Types.VARCHAR);
//      psD.addBatch(); inserted++;
//  }
//
//  // --- Racikan (dari buffer: bisa Batuk & Nyeri sekaligus) ---
//  for (RacikanItem it : stagedRacikan){
//      psD.setString(1,noResep);
//      psD.setString(2,it.kode);
//      psD.setDouble(3,it.jml);
//      psD.setString(4,(it.satuan==null||it.satuan.isEmpty())?null:it.satuan);
//      psD.setString(5,it.signa);
//      psD.setString(6,it.namaRacikan);
//      psD.setString(7,"Racikan");
//      psD.addBatch(); inserted++;
//  }
//
//  if (inserted==0) { JOptionPane.showMessageDialog(null,"Tidak ada item dengan jumlah > 0."); return; }
//  psD.executeBatch();
//}
//stagedRacikan.clear();
//
//
//        koneksi.commit();
//        JOptionPane.showMessageDialog(null, "Resep toko berhasil disimpan (gabungan).");
//
//        if (tokoRef != null) tokoRef.onResepTokoSaved(noResep);
//
//        // === Reset kedua tabel ===
//        resetQty(tbTokoBarang, true);   // true = reset kolom aturan juga
//        resetQty(tbTokoBarang1, false);
//        if (SignaRacikan != null) SignaRacikan.setText("");
//
//    } catch (Exception e) {
//        try { koneksi.rollback(); } catch (Exception ex) {}
...
/** Cek apakah ada baris dengan qty > 0 di kolom qtyIndex */
private boolean adaItemQty(javax.swing.JTable tbl, int qtyIndex) {
    if (tbl == null) return false;
    for (int i = 0; i < tbl.getRowCount(); i++) {
        double j = Valid.SetAngka(String.valueOf(tbl.getValueAt(i, qtyIndex)));
        if (j > 0) return true;
    }
    return false;
}

/** Reset kolom jumlah ke 0, dan (opsional) kosongkan kolom aturan pakai untuk Non Racikan */
private void resetQty(javax.swing.JTable tbl, boolean kosongkanAturan) {
    if (tbl == null) return;
    for (int i = 0; i < tbl.getRowCount(); i++) {
        tbl.setValueAt(0.0, i, 0);
        if (kosongkanAturan) { // hanya non racikan yang punya kolom aturan (index 1)
    ...
    public void emptTeksobat() {
        if(ChkRM.isSelected()==true){
            String tgl = Valid.SetTgl(DTPBeri.getSelectedItem()+""); // "YYYY-MM-DD"
...
//            Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(resep_toko.no_resep,4),signed)),0) from resep_toko where resep_toko.tgl_resep='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' or resep_toko.created_at='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ",
//                DTPBeri.getSelectedItem().toString().substring(6,10)+DTPBeri.getSelectedItem().toString().substring(3,5)+DTPBeri.getSelectedItem().toString().substring(0,2),4,NoResep);        
    ...
    private void tampilTokoBarang(String keyword) {
    // === 1) BACKUP draft yang sudah diisi (jumlah > 0 atau aturan tidak kosong) ===
    int rowCount = tbTokoBarang.getRowCount();
    java.util.List<Object[]> draft = new java.util.ArrayList<Object[]>();
    for (int i = 0; i < rowCount; i++) {
        double jml = 0.0;
        try {
            Object v = tbTokoBarang.getValueAt(i, 0);
            if (v instanceof Number) jml = ((Number) v).doubleValue();
            else if (v != null) jml = Double.parseDouble(v.toString());
        } catch (Exception e) { jml = 0.0; }

        String aturan = String.valueOf(tbTokoBarang.getValueAt(i, 1));
        String kode   = String.valueOf(tbTokoBarang.getValueAt(i, 2));
        String nama   = String.valueOf(tbTokoBarang.getValueAt(i, 3));
        String kate   = String.valueOf(tbTokoBarang.getValueAt(i, 4));
        String satuan = String.valueOf(tbTokoBarang.getValueAt(i, 5));
        double stok   = 0.0;
        try {
            Object s = tbTokoBarang.getValueAt(i, 6);
            if (s instanceof Number) stok = ((Number) s).doubleValue();
            else if (s != null) stok = Double.parseDouble(s.toString());
        } catch (Exception e) { stok = 0.0; }
        String kand   = String.valueOf(tbTokoBarang.getValueAt(i, 7));

        if (jml > 0 || (aturan != null && !aturan.trim().isEmpty())) {
            draft.add(new Object[]{ jml, aturan, kode, nama, kate, satuan, stok, kand });
        }
    }
    ...
    // === 3) RESTORE draft ===
    for (Object[] d : draft) {
        tabModeBarang.addRow(d);
    }

    // === 4) APPEND hasil pencarian dari tokobarang ===
    final String like = "%" + (keyword == null ? "" : keyword.trim()) + "%";

    // Catatan skema:
    // - Minimal ambil dari tokobarang: kode_brng, nama_brng, kode_sat, stok, kandungan
    // - Kategori: jika ada tabel kategori (mis. tokojenisbarang), JOIN-kan; jika tidak ada, isi "".
    String sql =
        "SELECT " +
    "  tb.kode_brng, " +
    "  tb.nama_brng, " +
    ...
    rs.getString("kandungan")
            ...
            // skip jika sudah ada di draft (hindari duplikat entri)
//            boolean exist = false;
//            for (Object[] d : draft) {
//                if (kode.equals(String.valueOf(d[2]))) { exist = true; break; }
//            }
//            if (!exist) {
//                tabModeBarang.addRow(new Object[]{
//                    0.0, "", kode, nama, kate, satuan, stok, kand
//                });
//            }
        }
    } catch (Exception e) {
        System.out.println("tampilTokoBarang(): " + e.getMessage());
    } finally {
    ...
    // NON-RACIKAN (tetap nama lama)
// === RACIKAN TANPA is_racikan: match NAMA saja, stok > 0, relevansi ===
private void tampiltokobarang1(String keyword) {
    if (keyword == null) keyword = "";
    keyword = keyword.trim();
    String[] toks = keyword.isEmpty() ? new String[0] : keyword.split("\\s+");

    // BACKUP/RESTORE tbTokoBarang1 seperti yang sudah kamu buat...

    Valid.tabelKosong(tabModeBarang1);
// 1) Pilih rumus stok_total yang sesuai skema kamu
final String stokExpr = "COALESCE(tb.stok,0)*COALESCE(tb.isi,1)*COALESCE(tb.kapasitas,1)";
// kalau stok sdh satuan dasar: final String stokExpr = "COALESCE(tb.stok,0)";

// 2) Build SQL
StringBuilder sql = new StringBuilder();
sql.append("SELECT ")
   .append(" tb.kode_brng, tb.nama_brng, ")
   .append(" COALESCE(tj.nm_jenis,'') AS kategori, ")
   .append(" COALESCE(tb.kode_sat2,tb.kode_sat) AS satuan, ")
   .append(" ").append(stokExpr).append(" AS stok_total, ")
   .append(" COALESCE(tb.kandungan,'') AS kandungan ")
   .append("FROM tokobarang tb ")
   .append("LEFT JOIN tokojenisbarang tj ON tj.kd_jenis=tb.jenis ")
   .append("WHERE tb.status='1' ")
   .append("  AND ").append(stokExpr).append(" > 0 "); // hanya yang stoknya ada

// 3) Semua token HARUS match di salah satu kolom (nama/kode/kandungan)
for (int i = 0; i < toks.length; i++) {
    sql.append("AND (")
       .append(" UPPER(tb.nama_brng) LIKE ? ")
       .append(" OR UPPER(tb.kode_brng) LIKE ? ")
       .append(" OR UPPER(COALESCE(tb.kandungan,'')) LIKE ? ")
       .append(") ");
}
...
if (toks.length > 0) {
    sql.append("CASE ")
       .append(" WHEN UPPER(tb.nama_brng) LIKE ? THEN 0 ")         // nama prefix
       .append(" WHEN UPPER(COALESCE(tb.kandungan,'')) LIKE ? THEN 1 ") // kandungan contains
       .append(" WHEN UPPER(tb.kode_brng) LIKE ? THEN 2 ")          // kode prefix
       .append(" ELSE 3 END, ");
}
sql.append("tb.nama_brng ASC LIMIT 100");
...
try (PreparedStatement ps = koneksi.prepareStatement(sql.toString())) {
    ...
    for (String t : toks) {
        ...
        ps.setString(p++, "%" + T + "%"); // nama contains
        ps.setString(p++, "%" + T + "%"); // kode contains
        ps.setString(p++, "%" + T + "%"); // kandungan contains
    }
    if (toks.length > 0) {
        String T0 = toks[0].toUpperCase();
        ps.setString(p++, T0 + "%");        // nama prefix
        ps.setString(p++, "%" + T0 + "%");  // kandungan contains
        ps.setString(p++, T0 + "%");        // kode prefix
    }
        int added=0;
        try (ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
        ...
        System.out.println("[racikan] added rows=" + added);
    } catch (Exception e) {
        e.printStackTrace();
    }
}

    // Helper aman parsing angka dari sel JTable
private static double toDouble(Object v) {
    ...
    // Normalisasi: "1.234,56" -> "1234.56"
    s = s.replaceAll("\\s+", "");
    if (s.matches(".*\\d,\\d{1,}$")) {
        s = s.replace(".", "").replace(",", ".");
    } else {
        s = s.replace(",", ""); // buang pemisah ribuan
    }
...
private void initTabIndexes() {
    TAB_IDX_NON_RACIKAN = TabRawat.indexOfTab(TAB_NON_RACIKAN_TITLE);
    TAB_IDX_RACIKAN     = TabRawat.indexOfTab(TAB_RACIKAN_TITLE);
}

private void refreshByActiveTab(String keyword) {
    System.out.println("[refresh] called kw='" + keyword + "'");
        if (TAB_IDX_NON_RACIKAN == -1 || TAB_IDX_RACIKAN == -1) {
        initTabIndexes();
        System.out.println("[refresh] init idx => non=" + TAB_IDX_NON_RACIKAN + ", racik=" + TAB_IDX_RACIKAN);
    }

    int idx = TabRawat.getSelectedIndex();
    System.out.println("[refresh] selected idx=" + idx);

    if (idx < 0) {
        System.out.println("[refresh] no tab selected, return");
        return;
    }
    ...
    if (idx == TAB_IDX_RACIKAN) {
        ...
        tampiltokobarang1(keyword);
    } else if (idx == TAB_IDX_NON_RACIKAN) {
        System.out.println("[refresh] go NON-RACIKAN");
        tampilTokoBarang(keyword);
    } else {
        System.out.println("[refresh] idx tidak match konstanta, cek via title");
        if (title != null && title.trim().equalsIgnoreCase(TAB_RACIKAN_TITLE)) {
            System.out.println("[refresh] match title RACIKAN");
            tampiltokobarang1(keyword);
        } else if (title != null && title.trim().equalsIgnoreCase(TAB_NON_RACIKAN_TITLE)) {
            System.out.println("[refresh] match title NON-RACIKAN");
            tampilTokoBarang(keyword);
        } else {
            System.out.println("[refresh] tab lain, skip");
        }
    }
}
...
//   public void autoNoResepToko() {
//    // ambil tanggal dari komponen tanggal kamu (mis. DTPBeri)
//    String tglDb = Valid.SetTgl(DTPBeri.getSelectedItem() + ""); // ke format YYYY-MM-DD
//
//    // prefix = YYYYMMDD (diambil dari tampilan DTPBeri dd-MM-YYYY)
//    String s = DTPBeri.getSelectedItem().toString();
//    String prefix = s.substring(6,10) + s.substring(3,5) + s.substring(0,2);
//
//    // cari MAX 4 digit terakhir untuk tanggal itu
//    String sql =
//        "SELECT IFNULL(MAX(CONVERT(RIGHT(rt.no_resep,4),SIGNED)),0) " +
//        "FROM resep_toko rt " +
//        "WHERE DATE(rt.tgl_resep)='" + tglDb + "'";
//
//    // panjang urut 4 digit → 0001, 0002, ...
//    Valid.autoNomer3(sql, prefix, 4, NoResepToko);
//}
...
private static final int COL_NAMA_RACIK = 7;

private void commitTableEdits(JTable... tables){
    for (JTable t: tables){
        if (t!=null && t.isEditing()) {
            try { t.getCellEditor().stopCellEditing(); } catch(Exception ignored){}
        }
    }
}
...
private void setToolbarResepVisible(boolean visible) {
    // sesuaikan nama variabel dengan yang ada di Navigator kamu
    label12.setVisible(visible);     // label "Tarif :"
    Jeniskelas.setVisible(visible);  // combobox tarif

    BtnTambah.setVisible(visible);
    BtnSeek5.setVisible(visible);
    BtnSimpan.setVisible(visible);
    BtnTambah1.setVisible(visible);
    BtnHapus.setVisible(visible);
    
    

    // ganti 'panel3' dengan panel container tempat toolbar itu berada
    panelisi3.revalidate();
    panelisi3.repaint();
}

// helper biar enak dipanggil

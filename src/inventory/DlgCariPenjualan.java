            ...
            if(tabMode.getRowCount()==0){
                ...
                if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                    ...
                    int jawab = JOptionPane.showConfirmDialog(null,
                        "Yakin ingin menghapus data penjualan ini?",
                    ...
                    if(jawab == JOptionPane.YES_OPTION){
                        try {
                            ...
                            try {
                                    ...
                                    if(rs.getString("status").equals("Sudah Dibayar")){
                                        if(akses.getkode().equals("Admin Utama")){
                                            ...
                                            try {
                                                ...
                                                if(psdetailjual != null){ psdetailjual.close(); }
                                            }
                                ...
                                if(rs != null){ rs.close(); }
                                if(pscarijual != null){ pscarijual.close(); }
                            }
                        } catch (Exception ex) {
                            System.out.println(ex);
                        }
                    } else {
                        JOptionPane.showMessageDialog(null, "Penghapusan dibatalkan oleh pengguna.");
                    }
                }
            }

...
public final class akses {
    ...
    public static boolean gethasil_endoskopi_faring_laring(){return akses.hasil_endoskopi_faring_laring;}
        ...
        //tambahan
    // --- Tambahkan di bagian atas class (bersama variabel lainnya) ---
private static double modalAwal = 0;
private static String modalAwalText = "";


// --- Tambahkan getter & setter berikut ---
public static void setModalAwal(double value){
    modalAwal = value;
}

public static double getModalAwal(){
    return modalAwal;
}

public static void setModalAwalText(String value){
    modalAwalText = value;
}

public static String getModalAwalText(){
    return modalAwalText;
}
}   

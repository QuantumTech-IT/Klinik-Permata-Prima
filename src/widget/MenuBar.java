...
public class MenuBar extends JMenuBar {
    ...
    // Definisikan warna hijau
    private final Color light = new Color(144, 238, 144, 100); // Light green with transparency
    private final Color dark = new Color(34, 139, 34, 100); // Dark green with transparency
    private final Color black = new Color(0, 0, 0, 0); // Transparent black
    private final Color warna = new Color(60, 179, 113); // Medium Sea Green
    ...
    private void setUpGradientImage() {
        ...
        // Gradient dari hijau medium ke transparent black
    ...
    private void setUpLigthImage() {
        ...
        // Gradient dari light green ke dark green

    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   "select satu_sehat_mapping_obat.obat_code,satu_sehat_mapping_obat.obat_system,tokobarang.status,"+
                   ...
                   "from satu_sehat_mapping_obat inner join tokobarang on satu_sehat_mapping_obat.kode_brng=tokobarang.kode_brng "+

...
public final class SatuSehatReferensiObatKFA extends javax.swing.JDialog {
    ...
    public void insertUpdate(DocumentEvent e) {
        SwingUtilities.invokeLater(() -> tampil(TCari.getText()));
    }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi KFA by API Kemenkes V2 ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if (TCari.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan Masukkan Keyword Pencarian");
        } else {
    ...
    private void getAllProducts() {
        ...
        try {
            ...
            String baseUrl = koneksiDB.URLKFAV2SATUSEHAT() + "/products/all";
            String params = String.format("page=%s&size=%s&product_type=%s",
                page,
                LimitData.getSelectedItem().toString(),
                URLEncoder.encode(ProductType.getSelectedItem().toString(), StandardCharsets.UTF_8));
...
//                .addParameter("product_type", ProductType.getSelectedItem().toString());
            ...
            if (!TCari.getText().isBlank()) {
                params += "&keyword=" + URLEncoder.encode(TCari.getText().trim(), StandardCharsets.UTF_8);
            }
//
            URI uri = new URI(baseUrl + "?" + params);
            
            //Package p = URIBuilder.class.getPackage();
           // System.out.println(p.getImplementationVersion());
            System.out.println("Token: " + api.TokenSatuSehat());

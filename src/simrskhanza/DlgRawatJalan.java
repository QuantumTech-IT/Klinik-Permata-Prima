...
//import rekammedis.DlgSOAPOldRalan;
...
//import rekammedis.ValidasiSOAPRalan;
...
//                        TKeluhan.setText(templatesoapie.getTable().getValueAt(templatesoapie.getTable().getSelectedRow(),3).toString());
//                        TPemeriksaan.setText(templatesoapie.getTable().getValueAt(templatesoapie.getTable().getSelectedRow(),4).toString());
//                        TPenilaian.setText(templatesoapie.getTable().getValueAt(templatesoapie.getTable().getSelectedRow(),5).toString());
//                        TindakLanjut.setText(templatesoapie.getTable().getValueAt(templatesoapie.getTable().getSelectedRow(),6).toString());
//                        TInstruksi.setText(templatesoapie.getTable().getValueAt(templatesoapie.getTable().getSelectedRow(),7).toString());
//                        TEvaluasi.setText(templatesoapie.getTable().getValueAt(templatesoapie.getTable().getSelectedRow(),8).toString());
//                    } 
...
//        templatesoapie.getTable().addKeyListener(new KeyListener() {
//            @Override
//            public void keyTyped(KeyEvent e) {}
//            @Override
//            public void keyPressed(KeyEvent e) {
...
//        });
    ...
    private void initComponents() {
        ...
        BtnBukaTemplateSoap = new widget.Button();
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-10-2023" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-10-2023" }));
        ...
        ChkTemplate.setBounds(910, 50, 23, 23);

        lblTemplate.setText("Jadikan Template SOAPIE/ CPPT");
        lblTemplate.setName("lblTemplate"); // NOI18N
        panelGlass12.add(lblTemplate);
        lblTemplate.setBounds(930, 50, 160, 23);

        BtnBukaTemplateSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnBukaTemplateSoap.setMnemonic('B');
        BtnBukaTemplateSoap.setText("Template SOAP/CPPT");
        BtnBukaTemplateSoap.setToolTipText("Alt+B");
        BtnBukaTemplateSoap.setName("BtnBukaTemplateSoap"); // NOI18N
        BtnBukaTemplateSoap.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnBukaTemplateSoap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBukaTemplateSoapActionPerformed(evt);
            }
        });
        BtnBukaTemplateSoap.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnBukaTemplateSoapKeyPressed(evt);
            }
        });
        panelGlass12.add(BtnBukaTemplateSoap);
        BtnBukaTemplateSoap.setBounds(910, 90, 180, 30);
        ...
        BtnVerifSoap.setBounds(910, 120, 28, 23);

        jLabel65.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel65.setText("Status Verifikasi CPPT/SOAP");
        jLabel65.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel65.setName("jLabel65"); // NOI18N
        panelGlass12.add(jLabel65);
        jLabel65.setBounds(950, 120, 200, 23);
        ...
        Scroll15.setPreferredSize(new java.awt.Dimension(192, 200));

        panelGlass17.setName("panelGlass17"); // NOI18N
        panelGlass17.setPreferredSize(new java.awt.Dimension(300, 400));
        ...
        scrollPane5.setBounds(70, 40, 360, 70);
        ...
        scrollPane11.setBounds(530, 120, 360, 70);
        ...
        TPegawai3.setBounds(1100, 10, 212, 23);
        ...
        KdPeg3.setBounds(980, 10, 115, 23);

        jLabel70.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel70.setText("Advis Dokter");
        jLabel70.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel70.setName("jLabel70"); // NOI18N
        panelGlass17.add(jLabel70);
        jLabel70.setBounds(230, 220, 80, 23);
        ...
        jLabel84.setBounds(370, 400, 200, 23);
        ...
        jLabel85.setBounds(850, 10, 130, 23);
        ...
        BtnVerifSbar1.setBounds(690, 250, 28, 23);
        ...
        jLabel99.setBounds(730, 250, 200, 23);

        Scroll15.setViewportView(panelGlass17);

        PanelInput4.add(Scroll15, java.awt.BorderLayout.CENTER);
        ...
        internalFrame11.add(Scroll12, java.awt.BorderLayout.CENTER);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-10-2023" }));
        ...
        BtnVerifikasiSOAP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnVerifikasiSOAP.setText("Verifikasi SOAP/CPPT");
        BtnVerifikasiSOAP.setFocusPainted(false);
        BtnVerifikasiSOAP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifikasiSOAP.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnVerifikasiSOAP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVerifikasiSOAP.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnVerifikasiSOAP.setName("BtnVerifikasiSOAP"); // NOI18N
        BtnVerifikasiSOAP.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnVerifikasiSOAP.setRoundRect(false);
        BtnVerifikasiSOAP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifikasiSOAPActionPerformed(evt);
            }
        });
        FormMenu.add(BtnVerifikasiSOAP);
                                ...
                                if(akses.getkode().equals(KdPeg.getText())){
                                    if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                                        ...
                                        LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),KdPeg.getText()})==true){
                                            ...
                                            JOptionPane.showMessageDialog(null,"SOAP/CPPT Sukses di Simpan");
                                            if (ChkTemplate.isSelected() == true) {
                                            TemplateSoap();
                                            }
                                            TSuhu.setText("");TTensi.setText("");TNadi.setText("");TRespirasi.setText("");
                        ...
                        if(tbPemeriksaanSbar.getSelectedRow()>-1){
                            if(akses.getkode().equals("Admin Utama")){
                                Sequel.mengedit("pemeriksaan_ralan_sbar","no_rawat='"+tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(),1)+
                                    ...
                                    "tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"',"+
                                    "jam_rawat='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"',"+
                                    "nip='"+KdPeg2.getText()+"',tulis='"+Tulis.getText()+"',baca='"+Baca.getSelectedItem()+"',konfirmasi='"+Konfirmasi.getSelectedItem()+"'");
                                tampilPemeriksaanSbar();
                                BtnBatalActionPerformed(evt);
                            }else{
                                if(akses.getkode().equals(tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(),22).toString())){
                                    Sequel.mengedit("pemeriksaan_ralan_sbar","no_rawat='"+tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(),1)+
                                        ...
                                        "no_rawat='"+TNoRw.getText()+"',situation='"+TSituation.getText()+"',background='"+TBackground.getText()+"',"+
                                        "assesment='"+TAssesment.getText()+"',recommendation='"+TRecommendation.getText()+"',"+
                                        "tgl_perawatan='"+Valid.SetTgl(DTPTgl.getSelectedItem()+"")+"',tulis='"+Tulis.getText()+"',"+
                                        "baca='"+Baca.getSelectedItem()+"',konfirmasi='"+Konfirmasi.getSelectedItem()+"'"+
                                        "jam_rawat='"+cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem()+"',");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnBukaTemplateSoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBukaTemplateSoapActionPerformed
//        akses.setform("DlgRawatJalan");
//        templatesoapie.emptTeks();
//        templatesoapie.isCek();
//        templatesoapie.setRM(KdPeg.getText(),TPegawai.getText());
...
//        templatesoapie.setVisible(true);
    }//GEN-LAST:event_BtnBukaTemplateSoapActionPerformed

    private void BtnBukaTemplateSoapKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnBukaTemplateSoapKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnBukaTemplateSoapKeyPressed
...
//        }else{
//            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//            DlgSOAPOldRalan soap=new DlgSOAPOldRalan(null,false);
//            soap.setNoRawat(TNoRw.getText(),TNoRw.getText());
//            soap.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
//            soap.setLocationRelativeTo(internalFrame1);
//            soap.setVisible(true);
...
//        }
    ...
    private void BtnVerifikasiSOAPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifikasiSOAPActionPerformed
//        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
//            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
//            TCari.requestFocus();
//        }else{
//            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//            ValidasiSOAPRalan form=new ValidasiSOAPRalan(null,false);
//            form.isCek();
//            form.emptTeks();
//            form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
//            form.tampil();
...
//            this.setCursor(Cursor.getDefaultCursor());
//        }
    }//GEN-LAST:event_BtnVerifikasiSOAPActionPerformed
    ...
    */
    ...
    private widget.Button BtnBukaTemplateSoap;
    ...
    private void TemplateSoap(){
        Valid.autoNomer("template_pemeriksaan_dokter","S",4,Kd);
        sukses=true;
        if(TKeluhan.getText().trim().equals("")){
            Valid.textKosong(TKeluhan,"Keluhan");
        }else if(TPemeriksaan.getText().trim().equals("")){
            Valid.textKosong(TPemeriksaan,"Obyektif");
        }else if(TPenilaian.getText().trim().equals("")){
            Valid.textKosong(TPenilaian,"Asesmen");
        }else if(TindakLanjut.getText().trim().equals("")){
            Valid.textKosong(TindakLanjut,"Planning");
        }else{
            if(Sequel.menyimpantf2("template_pemeriksaan_dokter","?,?,?,?,?,?,?,?","Template SOAP",8,new String[]{
                        Kd.getText(),KdPeg.getText(),TKeluhan.getText(),TPemeriksaan.getText(),TPenilaian.getText(),TindakLanjut.getText(),
                        TInstruksi.getText(),TEvaluasi.getText()
                        })==true){
                        JOptionPane.showMessageDialog(null,"Template SOAP Sukses di Simpan");
                        }else
                        {JOptionPane.showMessageDialog(null,"Template SOAP Gagal di Simpan");  
            }
        }
    }     
